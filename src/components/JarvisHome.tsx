...
export function JarvisHome({ onSubmit, placeholder = "输入你想咨询的问题..." }: JarvisHomeProps) {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col items-center pt-16 md:pt-24 pb-12 font-sans selection:bg-blue-100">
      ...
      >
        <div className="w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden mb-5 shadow-lg shadow-blue-500/10 ring-4 ring-white bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
          <span className="text-white text-2xl md:text-3xl font-bold">J</span>
        </div>
            ...
            {[
              ...
              <div key={i} className="group cursor-pointer bg-white rounded-[1.5rem] border border-gray-100 overflow-hidden hover:shadow-xl hover:shadow-gray-200/50 hover:border-gray-200 transition-all duration-300 flex flex-col">
                <div className="h-36 overflow-hidden relative">
                  <div className={`w-full h-full bg-gradient-to-br ${news.gradient} group-hover:scale-105 transition-transform duration-500 flex items-center justify-center`}>
